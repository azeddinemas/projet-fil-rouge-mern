...
const Show = (props) => {
  return (
    <div className="container-fluid container-lg m mx-auto p-3 m-0 border-0 bd-example" id="show" style={props.name}>
      ...
      <div id="car" className="carousel slide my-5" data-bs-ride="carousel">
        <div className="carousel-inner ">
          <div className="carousel-item active">
            <img src={banner1} height={350} width="100%" alt="..." />
          </div>
          <div className="carousel-item">
            <img src={banner2} height={350} width="100%" alt="..." />
          </div>
          <div className="carousel-item">
            <img src={banner3} height={350} width="100%" alt="..." />
          </div>
          <div className="carousel-item">
            <img src={banner4} height={350} width="100%" alt="..." />
          </div>
          <div className="carousel-item">
            <img src={banner5} height={350} width="100%" alt="..." />
          </div>
          <div className="carousel-item">
            <img src={show} height={350} width="100%" alt="..." />
          </div>
          <div className="carousel-item">
            <img src={show1} height={350} width="100%" alt="..." />
          </div>
        </div>

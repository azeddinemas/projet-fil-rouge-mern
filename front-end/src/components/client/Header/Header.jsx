  ...
  return (
    <header className="sticky-top d-flex justify-content-between bg-white shadow-lg p-2">
        <nav className="container-fluid d-flex align-items-center justify-content-between">
            <div>
                <Link to={'#'}><img src={img} width={90}/></Link>
            </div>
            <label htmlFor='menu' id="toggel">&#9776;</label>
            <input type="checkbox" className="d-none" id="menu"/>
            <div className="menu text-center">
                <label for="menu" id="toggel"><i className="bi bi-x-lg"></i></label>

    ...
    return (
        <div className="mt-4" id="packages" style={props.name}>
            ...
            <div className="container-fluid container-lg row d-flex flex-wrap mx-auto mt-3 p-3 justify-content-center">
                <Link className='text-end fw-bold' to={'/ourPackage'}>Get more &rarr;</Link>
                {pack.map((items) => (
                    <div className="col-xl-3 col-lg-3 col-md-4 col">
                        <div className="card shadow p-2 mb-5 rounded" >
                            ...
                            <div className="card-body">
                                <h5 className="card-title fs-3">{items.prix}DH&nbsp;<span className="text-decoration-line-through text-secondary fs-5 fw-lighter">4</span></h5>

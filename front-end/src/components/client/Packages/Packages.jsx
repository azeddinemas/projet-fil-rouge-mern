                ...
                {pack.map((items) => (
                    <div className="col-xl-3 col-lg-3 col-md-4 col" key={items._id}>
                        <div className="card shadow p-2 mb-5 rounded" >
                            <img src={`${API_URL}/` + items.image} alt='...' className="card-img-top rounded-3" />
                            ...
                            <div className="card-body">
                                ...
                                <p className="card-text">{items.description.slice(0, 86)}...</p>
                                <p>date de depart : {items.datedepart}</p>
                                <form>
                                    <Link to={`/detail/${items._id}`} type="submit" name="addreservation" style={{ background: "#F79F1F" }} className="btn text-white">go somewhere</Link>
                                </form>
                            </div>
                        </div>
                    </div>
